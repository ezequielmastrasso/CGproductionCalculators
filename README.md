...
|<img src="documentation/images/07.png" width="200">    |This graph shows the Man days required for each type of asset and<br> difficulty (difficulty is stacked on the same bar with a <br>similar same color)Man days means the amount of days that would take if only 1 man was doing the job        |
